...
typeof(x)
x[4]
# I have created the vector. The type of x is double and the 4th element is 9.
...
z=c(1,2,3)
x+z
# It won't work as x has 4 but z has 3 elements.
# FILL ME IN
```
...
# FILL ME IN
sum(x==1)
#Yes, I think that it is adding the no of 1s in the vector.
```
